...
const mockOrders = [
  {
    id: "order1",
    user: { name: "Ali Zorgui", email: "zorguimohamedali25@gmail.com" },
    createdAt: "2024-06-18 10:30",
    items: [
      {
        id: "item1",
        productName: "Pop-up Stand plat 1/3",
        productType: "popup-stands",
        size: "1/3",
        image: "/Stand-pop.png",
        link: "",
        quantity: 2,
      ...
      {
        id: "item2",
        productName: "Flag droit 2m",
        productType: "flags",
        size: "2m",
        image: "/flag.png",
        link: "https://custom-link.com",
        quantity: 1,
        options: { base: "water-22kg" },
      },
    ],
  },
  {
    id: "order2",
    user: { name: "Normal User", email: "user@example.com" },
    createdAt: "2024-06-18 11:00",
    items: [
      {
        id: "item3",
        productName: "Counter curved + Drap",
        productType: "counter",
        size: "curved",
        image: "/Counter.jpg",
        link: "",
